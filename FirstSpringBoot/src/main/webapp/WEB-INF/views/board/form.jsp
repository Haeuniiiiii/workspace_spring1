...
$(function() {
	...
	let addBtn = $("#addBtn");			// 등록 버튼 Element
	let cancelBtn = $("#cancelBtn");	// 취소 버튼 Element
	let listBtn = $("#listBtn");		// 목록 버튼 Element
	let boardForm = $("#boardForm");	// form Element
	
	// 등록 버튼 이벤트
	addBtn.on("click", function(){
		let title = $("#boTitle").val();		// 제목값
		
		// 일반적인 textarea element 를 통해서 가져온 값
		// let content = $("#boContent").val();	// 내용값
		// CKEDITOR를 통해서 가져온 값
